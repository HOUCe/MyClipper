...
8.  利用{z‘1,z’2,...z‘m}更新generator的参数θg，也就是让Vg 越小越好；
...
**3\. 定义discriminator的loss**。这里 d\_loss\_real 是 Dx 和标签 1 之间的 loss，d\_loss\_fake 是 Dg 和标签 0 之间的 loss。最后相加得到的 d\_loss 就是 discriminator 的整体 loss。
