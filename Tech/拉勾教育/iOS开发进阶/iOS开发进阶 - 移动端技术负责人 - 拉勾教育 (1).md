...
![图片2.png](https://s0.lgstatic.com/i/image6/M01/0A/3D/Cgp9HWA3F9SAPGu_AALEFvdRBzw539.png)
...
![图片3.png](https://s0.lgstatic.com/i/image6/M01/0A/3D/Cgp9HWA3GA-AYvZfAAND2HpeMGs775.png)
...
![图片1.png](https://s0.lgstatic.com/i/image6/M00/0A/39/CioPOWA3F5OAUokNAARwNdiYhbs294.png)
...
一旦安装 rbenv 完毕，我们需要把以下的设置信息放到你的 Shell 配置文件里面，例如 ~/.bash\_profile 或者 ~/.zshrc 等文件，这样能保证每次打开终端的时候都会初始化 rbenv。
...
![Drawing 3.png](https://s0.lgstatic.com/i/image6/M01/08/75/CioPOWA0xDCALL3FAABG42Ok7aU292.png)

### 总结

以上，我们通过 Xcode、rbenv、RubyGems 和 Bundler 搭建一个统一的 iOS 开发和构建环境。

![开发环境.png](https://s0.lgstatic.com/i/image6/M01/0A/39/CioPOWA3FsqAOn0YAAq1IyqbxEs043.png)
...
> README.md  
> [https://github.com/lagoueduCol/iOS-linyongjian/blob/main/README.md](https://github.com/lagoueduCol/iOS-linyongjian/blob/main/README.md)  
> Moments App 的.gitignore 文件  
> [https://github.com/lagoueduCol/iOS-linyongjian/blob/main/.gitignore](https://github.com/lagoueduCol/iOS-linyongjian/blob/main/.gitignore)
