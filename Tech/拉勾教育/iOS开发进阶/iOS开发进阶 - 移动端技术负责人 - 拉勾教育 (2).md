...
这几个操作符相里面，`~>`（Squiggy arrow）操作符更为常用，它是以最后一个部分的版本号（例子中 0.1.2 的最后一个部分是补丁版本号 _._.2）来计算可以支持的最高版本号。
...
> Podfile 文件地址：  
> [https://github.com/lagoueduCol/iOS-linyongjian/blob/main/Podfile](https://github.com/lagoueduCol/iOS-linyongjian/blob/main/Podfile)
