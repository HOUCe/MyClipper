...
**建立完整的性能优化知识体系。**你可以系统地学习相关知识，而不是碎片化获取，基础理论**实用性强，**直入主题，让你在工作实战时**有理可依，有据可循**。
...
另外，我去年就与拉勾教育平台合作了[《深入浅出 Java 虚拟机》（已完结）](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=31#/sale)课程，用户口碑还不错，Java 虚拟机这门课可作为 Java 性能优化课程的一个补充，我也推荐你去学习了解。
