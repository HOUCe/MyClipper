...
![1.png](https://s0.lgstatic.com/i/image/M00/09/1A/CgqCHl67twGANQ9kAABTpMHtYI0138.png)
...
![image (6).png](https://s0.lgstatic.com/i/image/M00/09/1A/CgqCHl67tw2AbgggAACW3WWz4D4066.png)

需要注意的一点是，**每个节点都有维护自身的 ACL 权限数据，即使是该节点的子节点也是有自己的 ACL 权限而不是直接继承其父节点的权限**。如下中“172.168.11.1”服务器有“/Config”节点的读取权限，但是没有其子节点的“/Config/dataBase\_Config1”权限。

![image (7).png](https://s0.lgstatic.com/i/image/M00/09/1B/CgqCHl67txWALBicAABysKoJmFg484.png)
...
![image (8).png](https://s0.lgstatic.com/i/image/M00/09/1B/CgqCHl67tyGAJKDxAABxRTWnmZs166.png)
