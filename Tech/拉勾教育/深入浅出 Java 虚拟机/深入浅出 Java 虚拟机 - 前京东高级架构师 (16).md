...
"sleep-demo" #12 prio=5 os\_prio=31 cpu=0.23ms elapsed=87.49s tid=0x00007fc7a7965000 nid=0x6003 waiting on condition  \[0x000070000756d000\]
...
"lock-demo" #12 prio=5 os\_prio=31 cpu=0.78ms elapsed=14.62s tid=0x00007ffc0b949000 nid=0x9f03 waiting on condition  \[0x0000700005826000\]
...
"http-nio-8084-exec-120" #143 daemon prio=5 os\_prio=31 cpu=122.86ms elapsed=317.88s tid=0x00007fedd8381000 nid=0x1af03 waiting for monitor entry  \[0x00007000150e1000\]
...
"wait-demo" #12 prio=5 os\_prio=31 cpu=0.14ms elapsed=12.58s tid=0x00007fb66609e000 nid=0x6103 in Object.wait()  \[0x000070000f2bd000\]
...
当然，关于线程的 dump，也有一些线上分析工具可以使用。下图是 的一个分析结果，但也需要你先了解这些情况发生的意义。
