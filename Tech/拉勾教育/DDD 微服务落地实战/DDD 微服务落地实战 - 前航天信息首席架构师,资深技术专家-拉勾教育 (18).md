...
[第 07 讲“在线订餐场景中是如何开事件风暴会议的？”](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=549#/detail/pc?id=5331)谈到了 DDD 中“事件风暴（Event Storming）”的实践方法。该方法认为，事件即事实（Event as Fact），即在业务领域中已经发生的事件就是事实（Fact）。过去发生的事件已经成为了事实，就不能再更改，因此信息管理系统就可以将这些事实以信息的形式存储到数据库中，即**信息就是一组事实**。
...
然而，按照“事件风暴”法完成对系统的分析与设计，最终落实到系统建设又应当怎样做呢？前面[第 08 讲“DDD 是如何解决微服务拆分难题的？”](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=549#/detail/pc?id=5332)通过讲解在线订餐系统，最终落实到领域事件的发布与通知机制：
...
![Drawing 0.png](https://s0.lgstatic.com/i/image2/M01/05/28/Cip5yF_9BX6AHn0MAABKrvbrCO8701.png)
