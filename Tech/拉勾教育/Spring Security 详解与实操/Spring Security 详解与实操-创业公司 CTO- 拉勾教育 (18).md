...
对于 Spring Security 而言，引入响应式编程技术同样会对传统实现方法带来一些变化。比方说，在[《03 | 认证](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=960#/detail/pc?id=7697)[体系：如何深入理解 Spring Security 的认证机制？](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=960#/detail/pc?id=7697)[》](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=960#/detail/pc?id=7697)课时中，我们已经知道 UserDetailsService 的作用是用来获取用户信息，你可以把它理解为是一种数据源，这样针对数据源的数据访问过程同样需要支持响应式编程。下面让我们一起来看一下这些变化吧。
...
在[《 10 |全局方法：如何确保方法级别的安全访问？》](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=960#/detail/pc?id=7704)课时中，我们介绍了 Spring Security 所提供的一个非常强大的功能，即全局安全方法机制。通过这种机制，无论是 Web 服务还是普通应用，都可以基于方法的执行过程来应用授权规则。
