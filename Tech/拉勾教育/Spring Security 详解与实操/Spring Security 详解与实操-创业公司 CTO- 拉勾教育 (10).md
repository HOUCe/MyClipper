...
![Drawing 0.png](https://s0.lgstatic.com/i/image6/M00/48/4F/CioPOWDUPfSAe8iSAABgIKGs6vA100.png)
...
可以发现，@PreAuthorize 注解与 [05 讲“访问授权：如何对请求的安全访问过程进行有效配置？”](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=960#/detail/pc?id=7699)中介绍的 access() 方法的原理是一样的，都是**通过传入一个 SpEL 表达式来设置访问控制规则**。
...
![Drawing 1.png](https://s0.lgstatic.com/i/image6/M00/48/46/Cgp9HWDUPgKAEHdqAABip-uyyzg495.png)
...
![Drawing 2.png](https://s0.lgstatic.com/i/image6/M00/48/48/Cgp9HWDUQa2Ac-ruAAKPFQeQ-YU960.png)
