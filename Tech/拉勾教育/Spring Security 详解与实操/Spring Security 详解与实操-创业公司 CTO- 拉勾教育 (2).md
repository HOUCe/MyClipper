...
![Drawing 0.png](https://s0.lgstatic.com/i/image6/M01/43/A3/CioPOWC5_duASv7jAACBgx8x8WU605.png)
...
![Drawing 1.png](https://s0.lgstatic.com/i/image6/M01/43/A3/CioPOWC5_fmAOso9AAAqvMlklW8869.png)
...
从上面的代码中，我们可以看到系统中存在“spring\_user”和“spring\_admin”这两个用户，其密码分别是"password1"和"password2"，在角色上也分别代表着普通用户 USER 以及管理员 ADMIN。
...
![Drawing 2.png](https://s0.lgstatic.com/i/image6/M01/43/A4/CioPOWC5_g-AP68cAACSqF1r51g526.png)

最后我想给你留一道思考题：你知道在 Spring Security 中有哪几种存储用户信息的实现方案吗？欢迎在留言区和我分享你的想法。

介绍完用户认证的使用方法之后，下一讲我们将深入框架内部，来剖析 Spring Security 中认证过程的实现原理。
