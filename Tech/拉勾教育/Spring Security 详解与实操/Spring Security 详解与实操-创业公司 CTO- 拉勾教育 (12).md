...
![Drawing 0.png](https://s0.lgstatic.com/i/image6/M01/4A/39/Cgp9HWDewCGALXXGAABc1HLmoQs176.png)
...
![Drawing 1.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewCqACykjAABqSG9fZc8154.png)
...
![Drawing 2.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewDCAIiUOAAB24Bx2cBU249.png)
...
-   access\_token：代表 OAuth2 的令牌，当访问每个受保护的资源时，用户都需要携带这个令牌以便进行验证。
    
-   token\_type：代表令牌类型，OAuth2 协议中有多种可选的令牌类型，包括 Bearer 类型、MAC 类型等，这里指定的 Bearer 类型是最常见的一种类型。
    
-   expires\_in：用于指定 access\_token 的有效时间，当超过这个有效时间，access\_token 将会自动失效。
    
-   refresh\_token：其作用在于当 access\_token 过期后，重新下发一个新的 access\_token。
...
![Drawing 3.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewDyAFnrhAABs_ltusFE367.png)
...
![Drawing 4.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewEWARSNPAACJjFnruAQ327.png)
...
![Drawing 5.png](https://s0.lgstatic.com/i/image6/M01/4A/39/Cgp9HWDewE2Ab2vhAABPDH7Zxjo001.png)
...
![Drawing 6.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewFaAKXrYAABQvvLUy-Q531.png)
...
![Drawing 7.png](https://s0.lgstatic.com/i/image6/M00/4A/41/CioPOWDewF2AG8SOAAGkQKcZcsU075.png)
