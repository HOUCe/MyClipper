...
![Drawing 3.png](https://s0.lgstatic.com/i/image/M00/46/C5/Ciqc1F9GH_aAejgOAApVk6oTdXk773.png)
...
**比喻的手法：** 这个手法我们经常用，多用在表现稍微抽象一点儿概念，不太好找实物去对应。所以这就要求我们在设计上展开丰富的想象，将这些概念的用途，用一些类似的实物作载体，比如，下图中密码用锁或用钥匙开锁来比喻，喜欢就用爱心来比喻。
