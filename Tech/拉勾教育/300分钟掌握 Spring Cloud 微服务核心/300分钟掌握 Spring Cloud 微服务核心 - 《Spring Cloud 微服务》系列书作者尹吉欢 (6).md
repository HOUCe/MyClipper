...
author: http://localhost:8087/cxytiandi
---
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzFGAEIQCAACesr5ZON8263.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFKAbTymAAE9eECzbLs575.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzFKAMhJuAADDrRk--Cs646.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzFKAe9wtAAEaJgA80DA706.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFKAVLC_AAE1Ij_9Yow275.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzFKAKGeOAAGndrQg2bE012.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFKALGjnAAEfSfAim3o535.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzI6AJcs6AFm-WMdMAzE612.gif)

我们快速体验下 Zuul 的路由功能，首先在 pom 中增加 spring-cloud-starter-netflix-zuul 的依赖，加完依赖之后，在启动类上增加 @EnableZuulProxy 注解。然后打开我们的配置文件，配置一个固定的路由 Zuul，.routes 是固定的前缀，yinjihuan 是命名，path 是映射的 URL 地址，URL 是要路由的地址。启动项目在浏览器中访问，可以看到打开了 cxytiandi.com 的主页。这就是一个简单的路由示列。
...
比如我们这边网关是 localhost:807，然后访问的服务是 feign-user-service，接口地址是user/get。最后完整的地址就是 [http://localhost:8087/feign-user-service/user/get?id=1](http://localhost:8087/feign-user-service/user/get?id=1)，访问下可以看到返回的结果。

###### Zuul 自定义过滤器

过滤器是 Zuul 中的核心内容，很多高级的扩展都需要自定义过滤器来实现，在 Zuul 中自定义一个过滤器只需要继承 ZuulFilter，然后重写 ZuulFilter 的四个方法即可。

![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFKARVycAADyi7HDY0s663.png)
...
-   [http://cxytiandi.com/blog/detail/20529](http://cxytiandi.com/blog/detail/20529)
    
-   [http://cxytiandi.com/blog/detail/20343](http://cxytiandi.com/blog/detail/20343)
    

###### Zuul Debug

![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFKAA6-IAAJL-BGCWm4337.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzFOAB1qqAAIJI02w_nQ520.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzFOAAazFAAGQ15EC0VY427.png)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzK2AcG7gAD4G9yHcYkM467.gif)
...
![](http://s0.lgstatic.com/i/image2/M01/9F/C6/CgotOV2yzLqAOifdADPJYsusPcA659.gif)
...
-   [http://cxytiandi.com/blog/detail/18782](http://cxytiandi.com/blog/detail/18782)
    

![](http://s0.lgstatic.com/i/image2/M01/9F/A6/CgoB5l2yzMiAfNk4AFxTR3S4aO4848.gif)
